                                                               ...
                                                               <div class="container-fluid ">
                                                                     ...
                                                                     <div class="row alert alert-success">
                                                                        ...
                                                                        <div class="col-sm-2">
                                                                            ...
                                                                            <a href="javascript:void(0)" class="icon-trash  bigger-110 icon-only btn-warning" title="删除" onclick="FireEvent.deleteCaseMem('${data.idx}','${n}')"></a>
                                                                        </div>
                                                                     </div>
                                                                     <!--$}-->
                                                               </div>
                                                                ...
                                                                <div class="container-fluid ">
                                                                     ...
                                                                     <div class="row alert alert-danger">
                                                                        ...
                                                                        <div class="col-sm-2">
                                                                            ...
                                                                            <a href="javascript:void(0)" class="icon-trash  bigger-110 icon-only btn-warning" title="删除" onclick="FireEvent.deleteCaseSession('${data.idx}','${n}')"></a>
                                                                        </div>
                                                                     </div>
                                                                     <!--$}-->
                                                               </div>
