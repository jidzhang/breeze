			...
			-->
				...
				<div  class="form-wrap pull-left clearfix">
					<div class="control-group c_Text">
						...
						<div class="controls">
							<input id="viewname" class="inp_text _name_inp" type="text" name="data.name" onkeyup="FireEvent.changeView(this.value);" onchange="FireEvent.changeView(this.value);">
					...
					<div class="control-group c_Text">
						...
						<div class="controls">
							<input id="viewdir" class="inp_text _name_inp" type="text" name="data.name" readonly="true">
							<span class="help-inline">
