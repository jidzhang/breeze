...
define(function(require, exports, module) {
    ...
    FW.register({
        ...
        */
            ...
            */
            "getTypeDecorateEditData": function(metadata, data) {
                ...
                var _data = {
                    metadata: metadata,
                    data: data,
                    appId: this.id.replace(/^field_/i, "")
                };
                ...
                //for (所有的gadget){将有getCfgInfo方法的取出，并创建对象
                for (var n in gadgets) {
                    oneGadget = gadgets[n];
                    //if(这个gadget存在getCfgInfo){获取配置信息
                    if (oneGadget["public"] && oneGadget["public"].getCfgInfo) {
                        if (oneGadget["public"].getCfgInfo()) {
                            ...
                            //if (已经存在){下一组循环
                            if (_data.cfgData[cfgObj.sig] != null) {
                                continue;
                            }
                            //}
        ...
        view: {
            'Info_Decorate': require("./resource/Info_Decorate/Info_Decorate.tpl")
        }
