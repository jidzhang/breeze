...
<form class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-lg-6" data-value="data.titile" data-type="Text">
			<input type="text" class="form-control" readonly="readonly" value="${data.alias}">
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-2">gadget</label>
		<div class="col-lg-6" data-value="data.type" data-type="Text">
			<input type="text" class="form-control" readonly="readonly" value="${data.gadgetName}">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-lg-6" data-value="data.typename" data-type="Text">
			/servicegadget/
			<input type="text" id="debugdir" class="form-control" value="${data.gadgetDir}">
				/${data.gadgetName}.js
		</div>
	</div>
	
	<div class="form-actions no-margin-bottom" style="text-align:center;">
		<input type="button" class="btn btn-success btn-lg btn-rect" value="编辑gadget" title="确认提交" onclick="FireEvent.newControl('${data.gadgetName}')">
